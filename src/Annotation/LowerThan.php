 ...
 * Class LowerThan
 *
 * Compare property value. Check if value is lower than the value defined.
 ...
 */
class LowerThan extends AbstractValidator
{
    /**
    ...
    public function errors()
    {
        if (!$this->isValid()) {
            ...
            return array('"' . $value . '" is not lower than "' . $this->value . '"');
        }
        return array();
    }
}